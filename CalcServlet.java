...
public class CalcServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String won = request.getParameter("won");//calculate 메서드 호출, won은 float으로 형변환, 
...
//			return;//리턴 없으면 환율계산기 부분이 따라나옴
		...
		//원화 입력 후 다시 servlet calc로 요청, webapp밑에 따로 html파일이 있는 것이 아니라 서블릿 안 html이기 때문에 범주를 벗어나서 프로젝트 위치부터 알려줘야함
